...
complete when it is not. If you need external data (binary-event research,
catalyst checks), fetch it inline yourself and keep going until every
covered asset has a `janus screen record` call.
