...
const cluster = (regime) => ({ metrics: { regime }, results: {} });
...
test("screen requires a regime source from the chosen read", () => {
    assert.throws(() => deriveScreen({ score: 5, confidence: 0.5 }, { metrics: {}, results: {} }, null, params), /regime/);
    assert.throws(() => deriveScreen({ score: 5, confidence: 0.5 }, macro(0.5), { metrics: {}, results: {} }, params), /regime/);
});
