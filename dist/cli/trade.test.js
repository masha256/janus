...
test("--size auto and --stop auto use the score plan sizing", async () => {
    await withHarness(async (file) => {
        ...
        withDb(file, (db) => {
            ...
            recordScreen(db, YESTERDAY, assetId, { flagged: true, rationale: null, metrics: { score: 8, confidence: 0.9 }, results: { screen_score: 7.2, threshold: 1, regime: 1.5, regime_smile: 0.9 } }, NOW);
